...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: 'Next.js', experience: '3+ years', code: 'export default function Page() {}' },
      { name: 'TypeScript', experience: '2+ years', code: 'interface User { name: string }' },
      { name: 'Tailwind CSS', experience: '4+ years', code: "className='bg-blue-500 text-white'" },
      { name: 'SASS/SCSS', experience: '4+ years', code: '$primary-color: #3498db;' },
    ],
  },
  {
    id: 'backend',
