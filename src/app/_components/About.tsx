...
const terminalCommands = [
  ...
  { command: "ls skills/", output: "react/ nextjs/ typescript/ nodejs/ python/ aws/" },
  { command: "cat experience.txt", output: "3+ years building scalable web applications" },
  { command: "grep -r 'passion' .", output: "./life: Creating digital experiences that matter" },
]
    ...
    <section className="min-h-screen flex items-center justify-center py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-green-500/20 text-green-400 px-4 py-2 rounded-full text-sm font-mono mb-6">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            Currently available for new projects
          </div>
          <h2 className="text-6xl lg:text-6xl font-black mb-6">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed min-h-[400px]">
                <div className="flex">
                  <div className="text-gray-500 select-none mr-4 text-right">
                    {Array.from({ length: Math.max(codeLines.length, typedCode.split("\n").length) }, (_, i) => (
            ...
            <div className="bg-black/90 backdrop-blur-xl rounded-2xl border border-green-500/30 overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center justify-between px-6 py-4 bg-green-500/10 border-b border-green-500/30">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-green-400 text-sm font-mono">sheraz@portfolio:~$</span>
                </div>
                <div className="flex gap-2">
                ...
                {showTerminal && terminalStep >= terminalCommands.length && (
                  <div className="mt-8 space-y-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white font-mono">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { icon: Coffee, value: "1000+", label: "Cups of Coffee", color: "text-amber-400" },
            { icon: Code, value: "50+", label: "Projects Built", color: "text-blue-400" },
            { icon: Zap, value: "99%", label: "Client Satisfaction", color: "text-green-400" },
            { icon: Github, value: "500+", label: "Commits This Year", color: "text-purple-400" },
          ].map((stat, index) => (
